...
replace github.com/ThreeDotsLabs/watermill-http/v2 => ./third_party/watermill-http

replace github.com/go-chi/chi => ./third_party/go-chi

replace github.com/go-chi/chi/v5 => ./third_party/go-chi-v5
...
require (
	...
	github.com/drblury/protoflow v0.5.1
